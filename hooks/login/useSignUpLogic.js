...
const useSignUpLogic = () => {
  ...
  const refs = {
    ...
    confirmPassword: useRef(null), // Cambiar este nombre
  };
  ...
  const validations = {
    ...
    confirmPassword: (value) =>
      value === refs.password.current.value
        ? ""
